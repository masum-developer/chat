        ...
        <View style={styles.container}>
            ...
            <View>
                <Calendar
                 ...
                 markedDates={{
                    '2024-03-20': {marked: true,dotColor:'red',selected:true, selectedColor:'#e9f7e9', selectedTextColor:'#27ac1f'},
                    '2024-03-10': {marked: true,dotColor:'red',backgroundColor:'red'},
                    '2024-03-07': {marked: true,dotColor:'#7666ff',backgroundColor:'red'},
                  }}
                 hideExtraDays ={true}
                 style={{
